      ...
      <div className="min-h-screen text-white p-4 md:p-8">
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="flex flex-col md:flex-row max-md:flex-wrap lg:flex-row lg:space-x-4">
            {/* Governance Card */}
            <div className="order-1 xl:order-2 lg:order-2 md:w-full lg:w-1/3 relative grid grid-rows-3">
              {/* Center Token Display - Full width on mobile, centered on larger screens */}
              <div className="row-span-6 flex justify-center items-center py-12 lg:py-0 order-first lg:order-none col-span-1 lg:col-span-1 max-w-[308px]">
                <div className="relative max-w-[250px] max-h-[250px]">
                  <Image src={TokenImage} alt="" />
                </div>
              </div>
              <div></div>
              <div className="row-span-6 text-center p-6 rounded-lg bg-opacity-10 max-w-[308px] ">
                <div className="flex justify-center mb-4">
                  <Check className="text-white" />
                </div>
                <h2 className="text-xl font-bold mb-4">Liquidity Mining</h2>
              ...
              <div className="token-vertical-line line-is-left w-[1px]"></div>
              <div className="token-vertical-line line-is-right w-[1px]"></div>
            </div>

            {/* Transaction Fees Card */}
            <div className="order-2 xl:order-1 lg:order-1 lg:w-1/3 grid grid-rows-3">
              <div className="row-span-6 text-center p-6 rounded-lg bg-opacity-10 max-w-[308px]">
                <div className="flex justify-center mb-4">
                  <Check className="text-white" />
                </div>
              ...
              <div className="token-horizontal-line h-[1px]"></div>
            ...
            <div className="order-3 xl:order-3 lg:order-3 lg:w-1/3 grid grid-rows-3">
              <div className="row-span-6 text-center p-6 rounded-lg bg-opacity-10 max-w-[308px]">
                <div className="flex justify-center mb-4">
                  <Check className="text-white" />
                </div>
