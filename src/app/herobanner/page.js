...
import pricechart from '@/assets/image/pricechart.png'
...
const HeroSection = () => {
    return (
        ...
        <section id="hero" className={styles.section_hero}>
            <div className={`${styles.w_layout_blockcontainer} ${styles.container} ${styles.w_container}`}>
                <div className={styles.hero_wrapper}>
                    <div className={styles.hero_main}>
                        <div className={`${styles.hero_main_left} ${styles.hero_main_left_sub}`}>
                            <div data-w-id="24148052-0508-b3d0-ee2b-ef28262d5109" className={styles.hero_traders}>
                            ...
                            <h1 data-w-id="f4b480cd-a3bb-2df9-5bd5-145ca8420f25" className={`${styles.heading_style_h1} ${styles.heading_style_h1_sub}`}>Build, Manage, and Invest
                                in DeFi Crypto Funds <span className={styles.h1_accent}>with AI</span></h1>
                            <p data-w-id="09655fda-43f8-5554-1956-d0f583583dc3" className={`${styles.hero_text} ${styles.hero_sub_text}`}>B3X is the most advanced AI-driven
                            ...
                            <div data-w-id="f694fa7c-6427-8e03-946a-095c43a65ae2" className={`${styles.hero_buttons} ${styles.hero_button_sub}`}><a href="#"
                                className={`${styles.primary_button} ${styles.is_green} `}> {/*${styles.w_inline_block}*/}
                                <div>Read Pitch Deck</div>
                                <div className={`${styles.primary_button_arrow_wrapper} ${styles.is_white}`}>
                                ...
                                <div className={styles.hero_secondary_button_wrap}><a data-w-id="f8b900c2-6a2e-256e-3739-b47bd5c36b2a"
                        ...
                        <div id="w-node-_3b7ddaf9-015a-5121-c351-149dd7cd6d4c-70c9e965"
                            ...
                            <div className="hero_trustpilot is-mobile"><img
                                src="66d9977e72e7dfd970c9e964/66d9977e72e7dfd970c9e97c_trustpilot-logo.svg" loading="eager" alt=""
                                className="trustpilot_logo" /><img
                                    src="66d9977e72e7dfd970c9e964/66d9977e72e7dfd970c9e98b_trustpilot-stars.svg" loading="eager"
                                    width="129" alt="" className="trustpilot_stars" />
